  ...
  return (
    <div className='shadow border hover:shadow-md duration-150 '>
      ...
      <div className='grid grid-cols-4'>
        ...
        <p className='text-sm text-gray-700 col-span-4 px-2 smx:mb-3 h-20'>
          {description}
        </p>
        <div className='flex justify-evenly col-span-2 items-center sm:pr-8 py-3 bg-gray-100'>
          <MdThumbUp
          ...
          <MdThumbDown
            ...
            onClick={modDislikes}
            style={dislike ? { color: "rgb(185 28 28)" } : ""}
          />
        </div>
        <div className='text-end pr-2 py-3 col-span-2 bg-slate-100 text-blue-800 '>
